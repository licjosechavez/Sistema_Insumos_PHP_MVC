...
if (!empty($_POST)) {
  ...
  if (empty($_POST['codigo']) || empty($_POST['producto']) ) {
    ...
    //$precio = $_POST['precio'];
    $query_update = mysqli_query($conexion, "UPDATE producto SET codigo = '$codigo', descripcion = '$producto', proveedor= $proveedor WHERE codproducto = $codproducto");
    if ($query_update) {
      $alert = '<div class="alert alert-primary" role="alert">
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Editar insumo</h1>
      ...
      <div class="card">
        ...
        <div class="card-body">
         ...
         <!--   <div class="form-group">
            ...
            <input type="submit" value="Actualizar insumo" class="btn btn-success">
          </form>
        </div>
      </div>
    </div>
